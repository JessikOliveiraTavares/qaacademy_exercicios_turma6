...
public class Exerc5 {
    ...
    public String somando(double num1, double num2, double num3) {
        return "a soma dos numeros é " + (num1 + num2 + num3);
    ...
    public String subtracao(double num1, double num2, double num3) {
        return " a subtracao dos numeros é" + (num1 - num2 - num3);
    }
...
//    }
//
//    public double digitequalovalor(double num1, double num2, double num3) {
//        System.out.println("a soma dos numeros é " + (num1 + num2 + num3));
//        System.out.println(" a multiplicacao dos numeros é" + (num1 * num2 * num3));
//        System.out.println(" a subtracao dos numeros é" + (num1 - num2 - num3));
//        System.out.println(" a medias dos valores é" + (num1 + num2 + num3) / 3);
...
//
//
//            public double digiteumovalor ( double num1, double num2, double num3){
//                System.out.println("a soma dos numeros é " + (num1 + num2 + num3));
//                System.out.println(" a multiplicacao dos numeros é" + (num1 * num2 * num3));
//                System.out.println(" a subtracao dos numeros é" + (num1 - num2 - num3));
//                System.out.println(" a medias dos valores é" + (num1 + num2 + num3) / 3);
